            ...
            >
                <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                        <i className="fi fi-rr-envelope mt-1 size-5 text-zinc-500"></i>
                        <p className="text-zinc-500">
                            vistasoft.solutions@gmail.com
                        </p>
                    </div>

                    <div className="flex items-center gap-2">
                        <i className="fi fi-rr-phone-call mt-1 size-5 text-zinc-500"></i>
                        <p className="text-zinc-500">+591-75468783</p>
                    </div>

                    <div className="flex items-center gap-2">
                        <i className="fi fi-rr-marker mt-1 size-5 text-zinc-500"></i>
                        <p className="text-zinc-500">
                            Av. Fray Domingo Santo Tomás y c/ Ismael Vásquez
                            #1480
                        </p>
                    </div>
                </div>
